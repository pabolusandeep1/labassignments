...
object MainClass {
  ...
  def main(args: Array[String]) {
    ...
    System.setProperty("hadoop.home.dir","C:\\Users\\USER\\winutils");
    ...
    // RDD[ String ]
    val text = new String(Files.readAllBytes(Paths.get("C:\\Users\\USER\\Desktop\\entdataset.txt")))
    ...
    val y1=x1.flatMap(line=>{line.split(" ")}).filter(line => line.contains("PERSON")).collect()
